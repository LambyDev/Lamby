Contributing to lamby
============================

The lamby project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/LambyDev/Lamby/blob/master/doc/translation_process.md)
...
The following applies to code changes to the lamby project, and is not to be
confused with overall lamby Network Protocol consensus changes.

Whether a pull request is merged into lamby rests with the project merge
...
Patches that change lamby consensus rules are considerably more involved than
...
Where a patchset proposes to change the lamby consensus, it must have been
...
The project leader is the release manager for each lamby release.
