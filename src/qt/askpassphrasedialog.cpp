...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            lambyGUI* window = static_cast<lambyGUI*>(parentWidget());
...
{
    lambyGUI* gui = static_cast<lambyGUI*>(parentWidget());
...
{
    hide();
    static_cast<lambyGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Lamby will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your Lambys from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
