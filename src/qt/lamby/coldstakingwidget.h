...
#include "qt/lamby/furabstractlistitemdelegate.h"
#include "qt/lamby/txviewholder.h"
#include "qt/lamby/tooltipmenu.h"
#include "qt/lamby/sendmultirow.h"
#include "qt/lamby/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget(lambyGUI* parent);
    ~ColdStakingWidget();
