...
#include "qt/lamby/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/lamby/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(lambyGUI* _window, QWidget *parent) :
