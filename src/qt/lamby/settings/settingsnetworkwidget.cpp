...
#include "qt/lamby/settings/settingsnetworkwidget.h"
#include "qt/lamby/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/lamby/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(lambyGUI* _window, QWidget *parent) :
