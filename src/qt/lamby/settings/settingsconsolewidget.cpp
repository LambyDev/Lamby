...
#include "qt/lamby/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/lamby/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(lambyGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the Lamby RPC console.") + "<br>" +
