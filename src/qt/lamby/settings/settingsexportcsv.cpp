...
#include "qt/lamby/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(lambyGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("lamby_tx_csv_export(*.csv)") : tr("lamby_addresses_csv_export(*.csv)"),
                                        nullptr);
