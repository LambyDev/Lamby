...
#include "qt/lamby/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/lamby/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(lambyGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to lambyGUI::handleRestart()
