...
#include "qt/lamby/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/lamby/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(lambyGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableLamby,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableLamby,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableLamby,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableLamby,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableLamby, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableLamby);});
    ...
    if (parent)
        connect(parent, &lambyGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
