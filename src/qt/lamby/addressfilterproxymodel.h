...
#ifndef lamby_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define lamby_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //lamby_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
