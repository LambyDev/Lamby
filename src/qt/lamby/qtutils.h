...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, lambyGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, lambyGUI* gui, double posX = 3);
