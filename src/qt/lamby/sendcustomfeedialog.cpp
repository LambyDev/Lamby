...
#include "qt/lamby/sendcustomfeedialog.h"
#include "qt/lamby/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(lambyGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &lambyGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
