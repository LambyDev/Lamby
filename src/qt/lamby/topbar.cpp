...
#include "qt/lamby/topbar.h"
#include "qt/lamby/forms/ui_topbar.h"
#include "qt/lamby/lockunlock.h"
#include "qt/lamby/qtutils.h"
#include "qt/lamby/receivedialog.h"
#include "qt/lamby/loadingdialog.h"
...
TopBar::TopBar(lambyGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopLamby}, "amount-small-topbar");
    setCssProperty({ui->labelAmountLamby}, "amount-topbar");
    setCssProperty({ui->labelPendingLamby, ui->labelImmatureLamby}, "amount-small-topbar");
    ...
    ui->pushButtonStack->setVisible(false); // Lamby // hide
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("lamby")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // Lamby Total
    QString totalLamby = GUIUtil::formatBalance(balance, nDisplayUnit);

    // Lamby
    // Top
    ui->labelAmountTopLamby->setText(totalLamby);
    // Expanded
    ui->labelAmountLamby->setText(totalLamby);
    ui->labelPendingLamby->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureLamby->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
