...
/** Utility functions used by the lamby Qt UI.
 */
namespace GUIUtil
{
...
// Render lamby addresses in monospace font
...
// Parse "lamby:" URI into recipient object, return true on successful parsing
