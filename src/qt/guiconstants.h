...
/* lamby GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Lamby"
#define QAPP_ORG_DOMAIN "lamby-crypto.com"
#define QAPP_APP_NAME_DEFAULT "Lamby-Qt"
#define QAPP_APP_NAME_TESTNET "Lamby-Qt-testnet"
