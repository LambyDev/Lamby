...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"lamby", "listmasternodes", &listmasternodes, true, true, false},
        {"lamby", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lamby", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"lamby", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"lamby", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"lamby", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lamby", "masternodedebug", &masternodedebug, true, true, false},
        {"lamby", "startmasternode", &startmasternode, true, true, false},
        {"lamby", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lamby", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lamby", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lamby", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lamby", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lamby", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lamby", "preparebudget", &preparebudget, true, true, false},
        {"lamby", "submitbudget", &submitbudget, true, true, false},
        {"lamby", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lamby", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lamby", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lamby", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lamby", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lamby", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lamby", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lamby", "checkbudgets", &checkbudgets, true, true, false},
        {"lamby", "mnsync", &mnsync, true, true, false},
        */
        {"lamby", "spork", &spork, true, true, false},
...
{
    return "> lamby-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8980/\n";
}
