...
1. Clone the lamby source code:

        git clone https://github.com/LambyDev/Lamby
        cd lamby
...
lamby is now available at `./src/lambyd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/lamby"

    touch "/Users/${USER}/Library/Application Support/lamby/lamby.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/lamby/lamby.conf"

The first time you run lambyd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/lamby/debug.log

Other commands:
-------

    ./src/lambyd -daemon # Starts the lamby daemon.
    ./src/lamby-cli --help # Outputs a list of command-line options.
    ./src/lamby-cli help # Outputs a list of RPC commands when the daemon is running.
