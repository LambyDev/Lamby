...
The script [extract-osx-sdk.sh](https://github.com/LambyDev/Lamby/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
lamby/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/LambyDev/Lamby/blob/master/doc/README_osx.md) for troubleshooting tips.
