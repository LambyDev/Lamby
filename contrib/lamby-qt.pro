...
RESOURCES += src/qt/lamby.qrc src/qt/lamby_locale.qrc

TRANSLATIONS += src/qt/locale/lamby_bg.ts \
                src/qt/locale/lamby_de.ts \
                src/qt/locale/lamby_en.ts \
                src/qt/locale/lamby_es.ts \
                src/qt/locale/lamby_fi.ts \
                src/qt/locale/lamby_fr.ts \
                src/qt/locale/lamby_it.ts \
                src/qt/locale/lamby_ja.ts \
                src/qt/locale/lamby_pl.ts \
                src/qt/locale/lamby_pt.ts \
                src/qt/locale/lamby_ru.ts \
                src/qt/locale/lamby_sk.ts \
                src/qt/locale/lamby_sv.ts \
                src/qt/locale/lamby_vi.ts \
                src/qt/locale/lamby_zh_CN.ts \
                src/qt/locale/lamby_zh_TW.ts
